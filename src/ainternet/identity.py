...
from .stability import stable, beta
...
class AgentIdentity:
    ...
    def generate(cls, domain: str) -> "AgentIdentity":
        ...
        Stability: STABLE (v1) — Ed25519, will not change.
    ...
    def sign(self, data: bytes) -> bytes:
        ...
        Stability: STABLE (v1) — Ed25519 signature, 64 bytes.
    ...
    def verify(self, data: bytes, signature: bytes) -> bool:
        ...
        Stability: STABLE (v1) — Ed25519 verification.
    ...
    def create_challenge(domain: str = "") -> bytes:
        ...
        Stability: STABLE (v1) — challenge format frozen.
    ...
    def to_registry(self) -> dict:
        ...
        Stability: STABLE (v1) — registry format frozen.
    ...
    def save(self, path: str | Path):
        ...
        Stability: STABLE (v1) — file format frozen.
